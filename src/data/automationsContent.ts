...
export const automationsData: AutomationSlideData[] = [
  {
    ...
    tagline: 'Be the first to respond — every time',
    statValue: '21x',
  ...
  },
  {
    ...
    tagline: 'Know who needs you right now',
    statValue: '67%',
  ...
  },
  {
    ...
    progressPercent: 80,
    description: "Some people need time before they're ready. This keeps the relationship warm — so when they ARE ready, you're the one they call.",
  ...
  },
  {
    ...
    progressPercent: 60,
    description: 'No more phone tag. Clients book when it works, get gentle reminders, and actually show up. You get your evenings back.',
  ...
  },
  {
    ...
    progressPercent: 100,
    description: "30+ things between offer and close. This tracks every one — so nothing slips and you're not the one chasing paperwork.",
  ...
  },
  {
    ...
    tagline: 'Stay in their world after closing',
    statValue: '6x',
    statLabel: 'HIGHER TRANSACTION RATES',
    statDescription: 'from personalized emails vs generic newsletters.',
    progressPercent: 100,
    description: "Your past clients trusted you with one of the biggest decisions of their lives. Stay in their world — so when someone asks 'know a good agent?' your name comes up.",
  ...
  },
  {
    ...
    tagline: 'Let great relationships speak for themselves',
    statValue: '41%',
