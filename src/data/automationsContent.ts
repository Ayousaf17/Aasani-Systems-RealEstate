...
export const automationsData: AutomationSlideData[] = [
  ...
  },
  {
    ...
    tagline: 'LEAD QUALIFICATION & SCORING',
    statValue: '67%',
  ...
  },
  {
    ...
    iconColor: 'text-teal-400',
    title: 'Never forget to\nfollow up again',
    tagline: 'SMART CRM SEQUENCES',
    statValue: '80%',
  ...
  },
  {
    ...
    iconColor: 'text-teal-400',
    title: '30 tasks per deal\nhandled',
    tagline: 'TRANSACTION COORDINATION',
    statValue: '30+',
  ...
  },
  {
    ...
    iconColor: 'text-teal-400',
    title: 'Referrals that\ncome to you',
    tagline: 'REVIEW & REFERRAL',
    statValue: '41%',
